export default {
  async fetch(request, env) {
    ...
    // LISTAR - usado pelo index.html e pelo WebApp do Telegram
    ...
    // CLICK - conta pro índice de "mais saem" e redireciona
    if (path === '/api/click') {
